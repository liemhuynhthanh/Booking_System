...
public class AuthenticationController {
  ...
  @Operation(summary = "Sign Up", description = "Tạo tài khoản mới với email chưa được đăng ký. Password được mã hóa bcrypt trước khi lưu.", security = @SecurityRequirement(name = ""))
  @ApiResponses({
  ...
  @Operation(summary = "Login", description = "Xác thực username/password, trả về accessToken và refreshToken. AccessToken dùng trong header `Authorization: Bearer <token>`.", security = @SecurityRequirement(name = ""))
  @ApiResponses({
