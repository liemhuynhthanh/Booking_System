...
public class AuthenticationController {
    ...
    @Operation(summary = "Đăng ký tài khoản", description = "Tạo tài khoản mới với email chưa được đăng ký. Password được mã hóa bcrypt trước khi lưu.", security = @SecurityRequirement(name = "") // endpoint
                                                                                                                                                                                                    // này
                                                                                                                                                                                                    // không
                                                                                                                                                                                                    // cần
                                                                                                                                                                                                    // auth
